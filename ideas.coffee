$(->
    ...
    on_idea_input = ->
        ...
        if not idea_text?.length
            ...
            $feedback_list_status.html('We found the following potential problem with your idea:')
        else
            $feedback_list_status.html('We found ' + visible_item_count + ' potential problems with your idea:')
        return
